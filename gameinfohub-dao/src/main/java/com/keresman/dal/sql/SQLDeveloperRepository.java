...
public class SQLDeveloperRepository implements DeveloperRepository {
  ...
  public int save(Developer developer) throws Exception {
    ...
    try (Connection con = ds.getConnection();
        CallableStatement stmt = con.prepareCall(CREATE_DEVELOPER)) {
  ...
  public void updateById(int id, Developer developer) throws Exception {
    DataSource ds = DataSourceSingleton.getInstance();
    try (Connection con = ds.getConnection();
        CallableStatement stmt = con.prepareCall(UPDATE_DEVELOPER)) {
  ...
  public Optional<Developer> findById(int id) throws Exception {
    DataSource ds = DataSourceSingleton.getInstance();
    try (Connection con = ds.getConnection();
        CallableStatement stmt = con.prepareCall(SELECT_DEVELOPER_BY_ID)) {
  ...
  public List<Developer> findAll() throws Exception {
    ...
    DataSource ds = DataSourceSingleton.getInstance();
    try (Connection con = ds.getConnection();
        CallableStatement stmt = con.prepareCall(SELECT_ALL_DEVELOPERS);
  ...
  public void deleteAll() throws Exception {
    DataSource ds = DataSourceSingleton.getInstance();
    try (Connection con = ds.getConnection();
        CallableStatement stmt = con.prepareCall(DELETE_ALL_DEVELOPERS)) {
