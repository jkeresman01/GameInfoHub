...
import com.keresman.dal.FavoriteGameRepository;
import com.keresman.model.Game;
import java.util.List;
import java.util.Optional;

public class SQLFavoriteGamesRepository implements FavoriteGameRepository{
    ...
    @Override
    public Optional<Game> findByUserId(int id) throws Exception {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    @Override
    public Optional<Game> findByGameId(int id) throws Exception {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
