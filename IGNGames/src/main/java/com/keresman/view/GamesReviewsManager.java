...
public class GamesReviewsManager extends IGNGamesManagerDesigner {
  ...
  public void miLogoutMouseClicked(MouseEvent evt) {
    ...
    dispose();
    SwingUtilities.invokeLater(() -> new GameReviewsWelcomeScreen().setVisible(true));
  }
}
